...
export default function AboutSection() {
  return (
    <section
      id="about"
      className="min-h-screen mx-auto w-full max-w-6xl px-6 py-16"
    >
      <motion.div
        ...
        <div className="about-container flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="left-about w-full md:w-1/2">
            ...
            <p className="text-lg text-gray-300 leading-relaxed mb-4">
              ...
              I love crafting clean, high performing, and accessible interfaces
            ...
            <p className="text-lg text-gray-300 leading-relaxed mb-4">
              ...
              Shopify to build and maintain accessible, impactful digital
              experiences.
            </p>
